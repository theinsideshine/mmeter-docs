...
<a href="/img/cfg_avanzada/cfg_mobile.jpg" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/cfg_mobile.jpg"
...
<a href="/img/cfg_avanzada/mmeter_http2.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/mmeter_http2.png"
...
<a href="/img/cfg_avanzada/basicos.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/basicos.png"
...
**Importante:** Debe reiniciar el equipo para ver el cambio de este parametro.
...
- **2 • BOOT + INIT_ZONES**: envía power_up y además un “snapshot” de zonas iniciales.
  ...
  ### Evento de arranque (BOOT)

Durante el arranque, el sistema notificacion de BOOT con información diagnóstica:
...
<a href="/img/cfg_avanzada/temp.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/temp.png"
...
<a href="/img/cfg_avanzada/hum.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/hum.png"
    alt="Mmeter – Configuración avanzada – Humedad"
    className="mm-feature-img"
    style={{ float: "right", margin: "0 1.5rem 1.5rem 0" }}
  />
</a>
...
<a href="/img/cfg_avanzada/luz.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/luz.png"
...
<a href="/img/cfg_avanzada/vpd.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/vpd.png"
...
<a href="/img/cfg_avanzada/horarios.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/horarios.png"
...
<a href="/img/cfg_avanzada/hys.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/hys.png"
...
<a href="/img/cfg_avanzada/flags.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/flags.png"
...
<a href="/img/cfg_avanzada/ro.png" target="_blank" rel="noreferrer">
  <img
    src="/img/cfg_avanzada/ro.png"
...
<video controls width="100%" style={{ maxWidth: "900px" }}>
  <source src="/video/cfg.mp4" type="video/mp4" />
